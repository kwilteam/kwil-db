...
type KwildConfig struct {
	...
	Hostname           string // a host name for the autogenerated TLS certificate
	TLSKeyFile         string // if TLSKeyFile is empty, the gRPC server not use TLS connections
	TLSCertFile        string
...
var (
	...
	Hostname = config.CfgVar{
		EnvName: "HOSTNAME",
		Field:   "Hostname",
		Default: "",
	}

	TLSKeyFile = config.CfgVar{
		EnvName: "TLS_KEY_FILE",
		Field:   "TLSKeyFile",
		Default: "",
	}

	TLSCertFile = config.CfgVar{
		EnvName: "TLS_CERT_FILE",
		Field:   "TLSCertFile",
		Default: "",
	}
