...
// //type logicalSchema
//
// // Operation implements the LogicalPlan interface.
//
...
// descend creates a new scope that refers current scope as parent.
...
// ascend returns the parent scope.
func (s *scope) ascend() *scope {
	return s.parent
}
