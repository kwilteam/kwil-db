...
import (
	...
	"github.com/kwilteam/kwil-db/internal/engine/procedural/visitors/clean"
	"github.com/kwilteam/kwil-db/internal/engine/procedural/visitors/generate"
	"github.com/kwilteam/kwil-db/internal/engine/procedural/visitors/typing"
)
...
func GeneratePLPGSQL(schema *types.Schema, pgSchemaName string,
	...
	for i, proc := range schema.Procedures {
		...
		cleanedParams, err := clean.CleanProcedure(parsed, proc, schema, sessionVarPrefix, sessionVarTypes)
		if err != nil {
			return nil, err
		}
