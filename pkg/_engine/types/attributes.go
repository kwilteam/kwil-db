...
type attributeFuncs map[AttributeType]func(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error)
...
func primaryKey(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
	return v, nil
}

// Unique does not modify the value
func unique(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
	return v, nil
}

// NotNull checks that the value is not NULL or empty
func notNull(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
...
func defaultValue(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
	// copy the value
	newValue := *attribute
	return &newValue, nil
}
...
func min(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
...
func max(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
	value, attr, err := asInts(v, attribute)
	if err != nil {
		return v, fmt.Errorf(`failed to convert values to ints: %w`, err)
	}
...
func minLength(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
...
func maxLength(v *ConcreteValue, attribute *ConcreteValue) (*ConcreteValue, error) {
	strVal, attrVal, err := asStringAndInt(v, attribute)
	if err != nil {
		return v, fmt.Errorf(`failed to convert values to strings and ints: %w`, err)
	}
...
// utility functions
func asInts(v *ConcreteValue, attribute *ConcreteValue) (int, int, error) {
	dataType := v.Type()
...
func asStringAndInt(v *ConcreteValue, attribute *ConcreteValue) (string, int, error) {
	dataType := v.Type()
	if !dataType.IsText() {
