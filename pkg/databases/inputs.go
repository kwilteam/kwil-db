...
type Parameter[T anytype.AnyValue] struct {
	...
	Modifier ModifierType `json:"modifier,omitempty" clean:"is_enum,modifier_type"`
}
...
func (p *Parameter[T]) GetModifier() ModifierType {
	return p.Modifier
}
...
type WhereClause[T anytype.AnyValue] struct {
	...
	Column   string                 `json:"column" clean:"lower"`
	Static   bool                   `json:"static"`
	Operator ComparisonOperatorType `json:"operator,omitempty" clean:"is_enum,comparison_operator_type"`
	Value    T                      `json:"value,omitempty" traverse:"shallow"`
	Modifier ModifierType           `json:"modifier,omitempty" clean:"is_enum,modifier_type"`
}
...
func (w *WhereClause[T]) GetModifier() ModifierType {
	return w.Modifier
}
