...
func Test_Execute(t *testing.T) {
	...
	type args struct {
		...
		finisher  func(*dataset3.Dataset) error
	}
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				finisher: func(database *dataset3.Dataset) error {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			outputs, err := ds.Execute(ctx, tt.args.procedure, tt.args.inputs, &dataset3.TxOpts{
...
func (d databaseWrapper) Prepare(stmt string) (dataset3.Statement, error) {
	return d.DB.Prepare(stmt)
}

func (d databaseWrapper) Savepoint() (dataset3.Savepoint, error) {
