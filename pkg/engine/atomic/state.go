...
type AtomicEngine struct {
	// activeDatasets is a set of all dbids that are currently active
	activeDatasets map[string]struct{}
...
func (a *AtomicEngine) BeginTransaction() (*Process, error) {
...
func (a *AtomicEngine) applyChange(ctx context.Context, change *change) error {
	...
	case ctCreateDataset:
		...
		a.activeDatasets[change.DBID] = struct{}{}
		return nil
	case ctDeleteDataset:
		delete(a.activeDatasets, change.DBID)
