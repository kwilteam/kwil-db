...
func generateExecutables(db *databases2.Database[anytype.KwilAny]) (map[string]*execTypes.Executable, error) {
...
func generateExecutable(db *databases2.Database[anytype.KwilAny], q *databases2.SQLQuery[anytype.KwilAny]) (*execTypes.Executable, error) {
...
func generateStatement(db *databases2.Database[anytype.KwilAny], q *databases2.SQLQuery[anytype.KwilAny]) (string, error) {
	switch q.Type {
...
func buildArgs(db *databases2.Database[anytype.KwilAny], q *databases2.SQLQuery[anytype.KwilAny]) ([]*execTypes.Arg, error) {
	args := []*execTypes.Arg{}
	var pos uint8 = 0
...
func buildArg(db *databases2.Database[anytype.KwilAny], q *databases2.SQLQuery[anytype.KwilAny], position uint8, param arger) (*execTypes.Arg, error) {
