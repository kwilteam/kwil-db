...
func TestService_CreateDatabase(t *testing.T) {
	...
	type args struct {
		ctx context.Context
		db  *apipb.CreateDatabaseRequest
	}
	tests := []struct {
		name    string
		fields  fields
...
func (m *MockDepositStore) GetSpent(address string) (*big.Int, error) {
	return big.NewInt(0), nil
}

func (m *MockDepositStore) SetSpent(addr string, amt *big.Int) error {
	return nil
}
