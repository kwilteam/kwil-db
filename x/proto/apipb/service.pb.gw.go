...
func RegisterKwilServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KwilServiceServer) error {
	...
	mux.Handle("GET", pattern_KwilService_ListDatabases_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/apisvc.KwilService/ListDatabases", runtime.WithHTTPPathPattern("/api/v0/{owner}/databases"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterKwilServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KwilServiceClient) error {
	...
	mux.Handle("GET", pattern_KwilService_ListDatabases_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/apisvc.KwilService/ListDatabases", runtime.WithHTTPPathPattern("/api/v0/{owner}/databases"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_KwilService_ListDatabases_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"api", "v0", "owner", "databases"}, ""))
