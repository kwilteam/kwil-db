...
var file_kwil_apisvc_service_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xb5, 0x05, 0x0a, 0x0b, 0x4b, 0x77,
	...
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x30, 0x2f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x6f,
...
var file_kwil_apisvc_service_proto_goTypes = []interface{}{
	...
	(*CUDRequest)(nil),           // 7: apisvc.CUDRequest
	(*ReadRequest)(nil),          // 8: apisvc.ReadRequest
	(*GetBalanceRequest)(nil),    // 9: apisvc.GetBalanceRequest
	(*ReturnFundsRequest)(nil),   // 10: apisvc.ReturnFundsRequest
	(*EstimateCostRequest)(nil),  // 11: apisvc.EstimateCostRequest
	(*GetMetadataResponse)(nil),  // 12: apisvc.GetMetadataResponse
	(*CUDResponse)(nil),          // 13: apisvc.CUDResponse
	(*ReadResponse)(nil),         // 14: apisvc.ReadResponse
	(*GetBalanceResponse)(nil),   // 15: apisvc.GetBalanceResponse
	(*ReturnFundsResponse)(nil),  // 16: apisvc.ReturnFundsResponse
	(*EstimateCostResponse)(nil), // 17: apisvc.EstimateCostResponse
}
var file_kwil_apisvc_service_proto_depIdxs = []int32{
	4,  // 0: apisvc.KwilService.Connect:input_type -> apisvc.ConnectRequest
	6,  // 1: apisvc.KwilService.GetMetadata:input_type -> apisvc.GetMetadataRequest
	7,  // 2: apisvc.KwilService.Cud:input_type -> apisvc.CUDRequest
	8,  // 3: apisvc.KwilService.Read:input_type -> apisvc.ReadRequest
	9,  // 4: apisvc.KwilService.GetBalance:input_type -> apisvc.GetBalanceRequest
	10, // 5: apisvc.KwilService.ReturnFunds:input_type -> apisvc.ReturnFundsRequest
	11, // 6: apisvc.KwilService.EstimateCost:input_type -> apisvc.EstimateCostRequest
	5,  // 7: apisvc.KwilService.Connect:output_type -> apisvc.ConnectResponse
	12, // 8: apisvc.KwilService.GetMetadata:output_type -> apisvc.GetMetadataResponse
	13, // 9: apisvc.KwilService.Cud:output_type -> apisvc.CUDResponse
	14, // 10: apisvc.KwilService.Read:output_type -> apisvc.ReadResponse
	15, // 11: apisvc.KwilService.GetBalance:output_type -> apisvc.GetBalanceResponse
	16, // 12: apisvc.KwilService.ReturnFunds:output_type -> apisvc.ReturnFundsResponse
	17, // 13: apisvc.KwilService.EstimateCost:output_type -> apisvc.EstimateCostResponse
