...
func genInformationSchemaFuncs() []*catalog.Function {
...
func genInformationSchema() *catalog.Schema {
	...
	s.Funcs = genInformationSchemaFuncs()
	s.Tables = []*catalog.Table{
		{
			...
			Columns: []*catalog.Column{
				...
				},
				{
					...
					Type:   &catalog.QualName{Name: "sql_identifier"},
					Length: toPointer(64),
				},
				{
				...
				},
				{
					...
					Type: &catalog.QualName{Name: "character_data"},
				},
			},
		},
		{
		...
		},
		{
			...
			Columns: []*catalog.Column{
				...
				{
					Name: "is_grantable",
					Type: &catalog.QualName{Name: "yes_or_no"},
				},
			},
		},
		{
		...
		},
		{
			...
			Columns: []*catalog.Column{
				...
				},
				{
					...
					Type:   &catalog.QualName{Name: "cardinal_number"},
					Length: toPointer(4),
				},
				{
		...
		},
		{
			...
			Columns: []*catalog.Column{
				...
				{
					Name:   "created",
					Type:   &catalog.QualName{Name: "time_stamp"},
					Length: toPointer(8),
				},
				{
					Name:   "last_altered",
