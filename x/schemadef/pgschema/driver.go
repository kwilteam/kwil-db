...
var _ sqlschema.PlanApplier = (*Driver)(nil)
...
func Open(db sqlutil.ExecQuerier) (sqlschema.Driver, error) {
	...
	return &Driver{
		conn:      c,
		Differ:    &sqlschema.Diff{DiffDriver: &diff{}},
		Inspector: &inspect{c},
		Planner:   &planner{},
	}, nil
}
...
func (d *Driver) ApplyChanges(ctx context.Context, changes []sqlschema.SchemaChange, opts ...sqlschema.PlanOption) error {
	return sqlschema.ApplyChanges(ctx, changes, d, opts...)
}

// Lock implements the sqlschema.Locker interface.
