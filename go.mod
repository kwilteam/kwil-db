...
require (
	...
	github.com/kwilteam/kuneiform v0.3.2-0.20230626225516-a9a612defd66
...
require (
	...
	github.com/kwilteam/kuneiform-grammar-go v0.3.2-0.20230626225210-894cd388c72a // indirect
