...
require go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.31.0

require go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.31.0 // indirect
