...
func (c *txServiceClient) Broadcast(ctx context.Context, in *BroadcastRequest, opts ...grpc.CallOption) (*BroadcastResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/Broadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) GetSchema(ctx context.Context, in *GetSchemaRequest, opts ...grpc.CallOption) (*GetSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/GetSchema", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) GetSchemaById(ctx context.Context, in *GetSchemaByIdRequest, opts ...grpc.CallOption) (*GetSchemaResponse, error) {
	out := new(GetSchemaResponse)
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/GetSchemaById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) ListDatabases(ctx context.Context, in *ListDatabasesRequest, opts ...grpc.CallOption) (*ListDatabasesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/ListDatabases", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) GetExecutables(ctx context.Context, in *GetExecutablesRequest, opts ...grpc.CallOption) (*GetExecutablesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/GetExecutables", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) GetExecutablesById(ctx context.Context, in *GetExecutablesByIdRequest, opts ...grpc.CallOption) (*GetExecutablesResponse, error) {
	out := new(GetExecutablesResponse)
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/GetExecutablesById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) ValidateSchema(ctx context.Context, in *ValidateSchemaRequest, opts ...grpc.CallOption) (*ValidateSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/ValidateSchema", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txServiceClient) GetAddress(ctx context.Context, in *GetAddressRequest, opts ...grpc.CallOption) (*GetAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tx.v0.TxService/GetAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TxService_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/Broadcast",
	}
...
func _TxService_GetSchema_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/GetSchema",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_GetSchemaById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/GetSchemaById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_ListDatabases_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/ListDatabases",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_GetExecutables_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/GetExecutables",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_GetExecutablesById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/GetExecutablesById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_ValidateSchema_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/ValidateSchema",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TxService_GetAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tx.v0.TxService/GetAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
