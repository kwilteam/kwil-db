...
func (c *pricingServiceClient) EstimateCost(ctx context.Context, in *EstimateRequest, opts ...grpc.CallOption) (*EstimateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pricing.v0.PricingService/EstimateCost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PricingService_EstimateCost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pricing.v0.PricingService/EstimateCost",
	}
...
var PricingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pricing.v0.PricingService",
