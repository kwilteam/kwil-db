...
// TxClient defines the methods that the transport layer should implement.
...
func WrapClient(ctx context.Context, client TxClient, options *ClientOptions) (*Client, error) {
