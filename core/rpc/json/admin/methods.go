...
const (
	...
	MethodProposeMigration      jsonrpc.Method = "admin.propose_migration"
	...
	MethodMigrationMetadata     jsonrpc.Method = "admin.migration_metadata"
	MethodMigrationGenesisChunk jsonrpc.Method = "admin.migration_genesis_chunk"
)
