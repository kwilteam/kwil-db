...
// 	protoc        v4.23.4
// source: kwil/tx/v1/signature.proto
...
func (x *Signature) Reset() {
	*x = Signature{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kwil_tx_v1_signature_proto_msgTypes[0]
...
func (*Signature) Descriptor() ([]byte, []int) {
	return file_kwil_tx_v1_signature_proto_rawDescGZIP(), []int{0}
}
...
var file_kwil_tx_v1_signature_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x6b, 0x77, 0x69, 0x6c, 0x2f, 0x74, 0x78, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x69, 0x67,
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x74, 0x78,
	0x22, 0x5d, 0x0a, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x28, 0x0a,
...
var (
	file_kwil_tx_v1_signature_proto_rawDescOnce sync.Once
	file_kwil_tx_v1_signature_proto_rawDescData = file_kwil_tx_v1_signature_proto_rawDesc
)

func file_kwil_tx_v1_signature_proto_rawDescGZIP() []byte {
	file_kwil_tx_v1_signature_proto_rawDescOnce.Do(func() {
		file_kwil_tx_v1_signature_proto_rawDescData = protoimpl.X.CompressGZIP(file_kwil_tx_v1_signature_proto_rawDescData)
	})
...
func file_kwil_tx_v1_signature_proto_init() {
	if File_kwil_tx_v1_signature_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_kwil_tx_v1_signature_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_kwil_tx_v1_signature_proto_goTypes,
		DependencyIndexes: file_kwil_tx_v1_signature_proto_depIdxs,
		MessageInfos:      file_kwil_tx_v1_signature_proto_msgTypes,
	}.Build()
	File_kwil_tx_v1_signature_proto = out.File
	file_kwil_tx_v1_signature_proto_rawDesc = nil
	file_kwil_tx_v1_signature_proto_goTypes = nil
	file_kwil_tx_v1_signature_proto_depIdxs = nil
}
