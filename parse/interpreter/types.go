...
// spendCost spends a certain amount of cost.
// If the cost exceeds the maximum cost, it returns an error.
func (e *executionContext) spendCost(cost int64) error {
...
func (e *executionContext) setVariable(name string, value common.Value) error {
	err := e.spendCost(e.costTable.GetVariableCost)
	if err != nil {
		return err
	}
	...
	err = e.spendCost(e.costTable.SetVariableCost + e.costTable.SizeCostConstant*int64(value.Size()))
	if err != nil {
		return err
	}
...
func (e *executionContext) allocateVariable(name string, value common.Value) error {
	err := e.spendCost(e.costTable.AllocateVariableCost + e.costTable.SizeCostConstant*int64(value.Size()))
	if err != nil {
		return err
	}
