...
// interpreter is a basic interpreter for Kuneiform procedures.
...
func (i *interpreter) VisitProcedureStmtDeclaration(p0 *parse.ProcedureStmtDeclaration) any {
...
func (i *interpreter) VisitProcedureStmtAssignment(p0 *parse.ProcedureStmtAssign) any {
	...
	return stmtFunc(func(ctx context.Context, exec *executionContext, ret returnChans) error {
		...
		case *parse.ExpressionArrayAccess:
			...
			err = exec.spendCost(exec.costTable.ArrayAccessCost + exec.costTable.SetVariableCost)
			if err != nil {
				return err
			}
...
func (i *interpreter) VisitProcedureStmtCall(p0 *parse.ProcedureStmtCall) any {
...
func (i *interpreter) VisitProcedureStmtForLoop(p0 *parse.ProcedureStmtForLoop) any {
	...
	return stmtFunc(func(ctx context.Context, exec *executionContext, ret returnChans) error {
		...
		for {
			...
			err = exec.spendCost(exec.costTable.LoopCost)
			if err != nil {
				return err
			}
...
func (i *interpreter) VisitLoopTermRange(p0 *parse.LoopTermRange) any {
...
func (i *interpreter) VisitLoopTermSQL(p0 *parse.LoopTermSQL) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitLoopTermVariable(p0 *parse.LoopTermVariable) any {
	return loopTermFunc(func(ctx context.Context, exec *executionContext) (loop loopReturn, err error) {
...
func (i *interpreter) VisitProcedureStmtIf(p0 *parse.ProcedureStmtIf) any {
...
func (i *interpreter) VisitProcedureStmtSQL(p0 *parse.ProcedureStmtSQL) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitProcedureStmtBreak(p0 *parse.ProcedureStmtBreak) any {
	return stmtFunc(func(ctx context.Context, exec *executionContext, ret returnChans) error {
		if err := exec.spendCost(exec.costTable.BreakCost); err != nil {
			return err
		}
...
func (i *interpreter) VisitProcedureStmtReturn(p0 *parse.ProcedureStmtReturn) any {
	...
	return stmtFunc(func(ctx context.Context, exec *executionContext, ret returnChans) error {
		if err := exec.spendCost(exec.costTable.ReturnCost); err != nil {
			return err
		}
...
func (i *interpreter) VisitProcedureStmtReturnNext(p0 *parse.ProcedureStmtReturnNext) any {
	valFns := make([]exprFunc, len(p0.Values))
	for j, v := range p0.Values {
		valFns[j] = v.Accept(i).(exprFunc)
	}
...
func (i *interpreter) VisitExpressionLiteral(p0 *parse.ExpressionLiteral) any {
	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		return common.NewVariable(p0.Value)
	})
}

func (i *interpreter) VisitExpressionFunctionCall(p0 *parse.ExpressionFunctionCall) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionForeignCall(p0 *parse.ExpressionForeignCall) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionVariable(p0 *parse.ExpressionVariable) any {
	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		return exec.getVariable(p0.Name)
	})
}

func (i *interpreter) VisitExpressionArrayAccess(p0 *parse.ExpressionArrayAccess) any {
	arrFn := p0.Array.Accept(i).(exprFunc)
	indexFn := p0.Index.Accept(i).(exprFunc)

	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		err := exec.spendCost(exec.costTable.ArrayAccessCost)
		if err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionMakeArray(p0 *parse.ExpressionMakeArray) any {
	valFns := make([]exprFunc, len(p0.Values))
	for j, v := range p0.Values {
		valFns[j] = v.Accept(i).(exprFunc)
	}
	...
	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		err := exec.spendCost(exec.costTable.MakeArrayCost)
		if err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionFieldAccess(p0 *parse.ExpressionFieldAccess) any {
	recordFn := p0.Record.Accept(i).(exprFunc)

	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		err := exec.spendCost(exec.costTable.GetVariableCost)
		if err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionParenthesized(p0 *parse.ExpressionParenthesized) any {
	return p0.Inner.Accept(i)
}

func (i *interpreter) VisitExpressionComparison(p0 *parse.ExpressionComparison) any {
...
func makeComparisonFunc(left, right exprFunc, cmpOps common.ComparisonOp) exprFunc {
	return func(ctx context.Context, exec *executionContext) (common.Value, error) {
		if err := exec.spendCost(exec.costTable.ComparisonCost); err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionLogical(p0 *parse.ExpressionLogical) any {
	left := p0.Left.Accept(i).(exprFunc)
	right := p0.Right.Accept(i).(exprFunc)
...
func makeLogicalFunc(left, right exprFunc, and bool) exprFunc {
	return func(ctx context.Context, exec *executionContext) (common.Value, error) {
		if err := exec.spendCost(exec.costTable.LogicalCost); err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionArithmetic(p0 *parse.ExpressionArithmetic) any {
	...
	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		if err := exec.spendCost(exec.costTable.ArithmeticCost); err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionUnary(p0 *parse.ExpressionUnary) any {
...
func makeUnaryFunc(val exprFunc, op common.UnaryOp) exprFunc {
	return exprFunc(func(ctx context.Context, exec *executionContext) (common.Value, error) {
		if err := exec.spendCost(exec.costTable.UnaryCost); err != nil {
			return nil, err
		}
...
func (i *interpreter) VisitExpressionIs(p0 *parse.ExpressionIs) any {
	left := p0.Left.Accept(i).(exprFunc)
	right := p0.Right.Accept(i).(exprFunc)
...
func (i *interpreter) VisitExpressionColumn(p0 *parse.ExpressionColumn) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionCollate(p0 *parse.ExpressionCollate) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionStringComparison(p0 *parse.ExpressionStringComparison) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionIn(p0 *parse.ExpressionIn) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionBetween(p0 *parse.ExpressionBetween) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionSubquery(p0 *parse.ExpressionSubquery) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitExpressionCase(p0 *parse.ExpressionCase) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitCommonTableExpression(p0 *parse.CommonTableExpression) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitSQLStatement(p0 *parse.SQLStatement) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitSelectStatement(p0 *parse.SelectStatement) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitSelectCore(p0 *parse.SelectCore) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitResultColumnExpression(p0 *parse.ResultColumnExpression) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitResultColumnWildcard(p0 *parse.ResultColumnWildcard) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitRelationTable(p0 *parse.RelationTable) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitRelationSubquery(p0 *parse.RelationSubquery) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitRelationFunctionCall(p0 *parse.RelationFunctionCall) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitJoin(p0 *parse.Join) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitUpdateStatement(p0 *parse.UpdateStatement) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitUpdateSetClause(p0 *parse.UpdateSetClause) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitDeleteStatement(p0 *parse.DeleteStatement) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitInsertStatement(p0 *parse.InsertStatement) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitUpsertClause(p0 *parse.UpsertClause) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitOrderingTerm(p0 *parse.OrderingTerm) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitActionStmtSQL(p0 *parse.ActionStmtSQL) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitActionStmtExtensionCall(p0 *parse.ActionStmtExtensionCall) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitActionStmtActionCall(p0 *parse.ActionStmtActionCall) any {
	panic("TODO: Implement")
}

func (i *interpreter) VisitIfThen(p0 *parse.IfThen) any {
