...
func (v *BaseProcedureParserVisitor) VisitNormal_call(ctx *Normal_callContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseProcedureParserVisitor) VisitForeign_call(ctx *Foreign_callContext) interface{} {
	return v.VisitChildren(ctx)
}
