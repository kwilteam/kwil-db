...
type ProcedureParserVisitor interface {
	...
	// Visit a parse tree produced by ProcedureParser#normal_call.
	VisitNormal_call(ctx *Normal_callContext) interface{}

	// Visit a parse tree produced by ProcedureParser#foreign_call.
	VisitForeign_call(ctx *Foreign_callContext) interface{}
