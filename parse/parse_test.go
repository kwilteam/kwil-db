...
func TestCreateActionStatements(t *testing.T) {
	tests := []struct {
		...
		// If you’d like, you can also have a `wantErr bool` field if you expect errors.
	}{
		{
		...
		},
		{
			...
			expect: &CreateActionStatement{
				...
				Public:     false,
				Parameters: []*NamedType{{Name: "$arr", Type: &types.DataType{Name: "int", IsArray: true}}},
				Returns: &ActionReturn{
					IsTable: false,
					Fields:  []*NamedType{{Name: "", Type: &types.DataType{Name: "int", IsArray: true}}},
				},
				Statements: []ActionStmt{
					&ActionStmtReturn{
						Values: []Expression{
		...
		},
		{
			...
			expect: &CreateActionStatement{
				...
				Public: true,
				Parameters: []*NamedType{
					{Name: "$vals", Type: &types.DataType{Name: "int", IsArray: true}},
				},
				Statements: []ActionStmt{
					&ActionStmtDeclaration{
		...
		},
		{
			...
			expect: &CreateActionStatement{
				...
				Public: true,
				Parameters: []*NamedType{
					{Name: "$arr", Type: &types.DataType{Name: "int", IsArray: true}},
				},
				Returns: &ActionReturn{
					IsTable: false,
					Fields: []*NamedType{
