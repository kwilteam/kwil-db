...
func (v *BaseAstVisitor) VisitDateTimeFunc(node *DateTimeFunction) any {
	return nil
}
...
func (v *BaseAstVisitor) VisitExpressionIsNull(node *ExpressionIsNull) any {
	return nil
}

func (v *BaseAstVisitor) VisitExpressionDistinct(node *ExpressionDistinct) any {
	return nil
}
