...
func (v *BaseKuneiformParserVisitor) VisitForeign_declaration(ctx *Foreign_declarationContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseKuneiformParserVisitor) VisitType_selector_list(ctx *Type_selector_listContext) interface{} {
	return v.VisitChildren(ctx)
}
