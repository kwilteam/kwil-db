...
type KuneiformParserVisitor interface {
	...
	// Visit a parse tree produced by KuneiformParser#foreign_declaration.
	VisitForeign_declaration(ctx *Foreign_declarationContext) interface{}
	...
	// Visit a parse tree produced by KuneiformParser#type_selector_list.
	VisitType_selector_list(ctx *Type_selector_listContext) interface{}
