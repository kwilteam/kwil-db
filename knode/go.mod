module github.com/kwilteam/kwil-db/knode
...
require (
	...
	github.com/kwilteam/kwil-db/libs/wal v0.0.0
...
replace (
	...
	github.com/kwilteam/kwil-db/knode v0.0.0 => ../knode
	github.com/kwilteam/kwil-db/libs/wal v0.0.0 => ../libs/wal
