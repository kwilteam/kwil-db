...
var logWaitStrategies = map[string]string{
	...
	"node0":       "comet node is now started",
	"node1":       "comet node is now started",
	"node2":       "comet node is now started",
	"node3":       "comet node is now started",
	"node4":       "comet node is now started",
	"node5":       "comet node is now started",
