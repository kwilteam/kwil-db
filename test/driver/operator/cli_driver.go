...
func (o *OperatorCLIDriver) TxSuccess(ctx context.Context, txHash types.Hash) error {
	var res respTxQuery
	err := o.runCommand(ctx, &res, "utils", "query-tx", txHash.String())
	if err != nil {
		return err
	}
...
func (o *OperatorCLIDriver) ValidatorNodeJoin(ctx context.Context) (types.Hash, error) {
	var res display.TxHashResponse
...
func (o *OperatorCLIDriver) ValidatorNodeLeave(ctx context.Context) (types.Hash, error) {
	var res display.TxHashResponse
...
func (o *OperatorCLIDriver) SubmitMigrationProposal(ctx context.Context, activationHeight, migrationDuration *big.Int) (types.Hash, error) {
	var res display.TxHashResponse
...
func (o *OperatorCLIDriver) ApproveMigration(ctx context.Context, migrationResolutionID *types.UUID) (types.Hash, error) {
	var res display.TxHashResponse
