...
func (o *OperatorCLIDriver) TriggerMigration(ctx context.Context, activationHeight, migrationDuration *big.Int, chainID string) ([]byte, error) {
	var res display.TxHashResponse
	err := o.runCommand(ctx, &res, "migration", "trigger", activationHeight.String(), migrationDuration.String(), chainID)
	if err != nil {
		return nil, err
	}
...
func (o *OperatorCLIDriver) ApproveMigration(ctx context.Context, migrationResolutionID string) ([]byte, error) {
	var res display.TxHashResponse
	err := o.runCommand(ctx, &res, "migration", "approve", migrationResolutionID)
	if err != nil {
		return nil, err
	}
...
func (o *OperatorCLIDriver) GenesisState(ctx context.Context) (bool, []byte, error) {
	var res struct {
