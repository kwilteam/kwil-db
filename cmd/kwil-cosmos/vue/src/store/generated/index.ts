...
import CmdKwilCosmosKwilKwil from './cmd/kwil-cosmos/kwil.kwil'
...
import KwilKwilKwil from './kwil/kwil.kwil'


export default { 
  CmdKwilCosmosKwilKwil: load(CmdKwilCosmosKwilKwil, 'kwil.kwil'),
  ...
  KwilKwilKwil: load(KwilKwilKwil, 'kwil.kwil'),
