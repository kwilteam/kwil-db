...
type Engine interface {
	...
	CreateDataset(ctx *TxContext, tx sql.DB, schema *Schema) error
	...
	ListDatasets(caller []byte) ([]*DatasetIdentifier, error)
...
type Accounts interface {
	...
	GetAccount(ctx context.Context, tx sql.Executor, account []byte) (*Account, error)
