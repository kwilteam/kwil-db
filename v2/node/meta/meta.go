...
func StoreDiff(ctx context.Context, db sql.TxMaker, original, new *types.NetworkParameters) error {
...
func diff(original, new *types.NetworkParameters) map[string][]byte {
