...
type Engine interface {
	...
	CreateDataset(ctx *TxContext, tx sql.DB, schema *ktypes.Schema) error
	...
	ListDatasets(caller []byte) ([]*ktypes.DatasetIdentifier, error)
...
type SchemaGetter interface {
	...
	GetSchema(dbid string) (*ktypes.Schema, error)
}
...
type NetworkParameters struct {
	...
	MigrationStatus ktypes.MigrationStatus
